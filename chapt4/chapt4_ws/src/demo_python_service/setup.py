...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'face_detect_client_sync_node=demo_python_service.face_detect_client_sync_node:main',
            'face_detect_client_async_node=demo_python_service.face_detect_client_async_node:main',
        ],
    },
)
